...
ary = [
    ...
    create_prpt("QList<Dropdownlist *>", 'dropdownlists', is_list=True, init_val="= new QList<Dropdownlist *>()"),
    create_prpt("QString", 'uniqueId', is_writable=False),
    create_prpt("QStringList", 'virtualInPorts', is_writable=False,init_val="= {}"),
    create_prpt("QList<MidiRoutePreset *>", 'midiRoutePresets', is_list=True, init_val="= new QList<MidiRoutePreset *>()"),
